...
String card_name = "TestAddCard"
String card_number = "4111111111111111"
String valid_date = "1225"
...
//type card name
WebUI.focus(findTestObject('Object Repository/Explore/Add_Cards/input-1_name_card'))
WebUI.doubleClick(findTestObject('Object Repository/Explore/Add_Cards/input-1_name_card'))
WebUI.setText(findTestObject('Object Repository/Explore/Add_Cards/input-1_name_card'), card_name)

//type card number 
WebUI.focus(findTestObject('Object Repository/Explore/Add_Cards/input-2_number_card'))
WebUI.doubleClick(findTestObject('Object Repository/Explore/Add_Cards/input-2_number_card'))
WebUI.setText(findTestObject('Object Repository/Explore/Add_Cards/input-2_number_card'), card_number)

//type valid date
WebUI.focus(findTestObject('Object Repository/Explore/Add_Cards/input-3_valid_date'))
WebUI.doubleClick(findTestObject('Object Repository/Explore/Add_Cards/input-3_valid_date'))
WebUI.setText(findTestObject('Object Repository/Explore/Add_Cards/input-3_valid_date'), valid_date)
